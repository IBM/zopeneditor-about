...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#startbutton').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#prerequisites').foundation('down', jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pre').delay(600));
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation();
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#startlink').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#prerequisites').foundation('down', jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pre').delay(500));
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation();
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#mobilelink').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#prerequisites').foundation('down', jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pre').delay(700));
});
...
module.exports = __webpack_require__(/*! /Users/rodney.wilson@ibm.com/Desktop/Repos/zowe-commercial/zopeneditor-about/src/assets/js/app.js */"./src/assets/js/app.js");
